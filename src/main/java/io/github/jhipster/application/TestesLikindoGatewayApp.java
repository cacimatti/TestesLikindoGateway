...
@EnableZuulProxy
public class TestesLikindoGatewayApp {

    private static final Logger log = LoggerFactory.getLogger(TestesLikindoGatewayApp.class);

    private final Environment env;

    public TestesLikindoGatewayApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes TestesLikindoGateway.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(TestesLikindoGatewayApp.class);
